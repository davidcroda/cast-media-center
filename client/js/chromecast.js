...
(function() {
  ...
  Excast = (function() {
    ...
    Excast.prototype.onStopSuccess = function(data) {
      console.log("Session stopped");
      this.appSession = this.mediaSession = null;
      return console.log(data);
    };

    Excast.prototype.onStopError = function(error) {
      return console.log(error);
    };

    Excast.prototype.onMediaError = function(error) {
      return console.log(error);
    };
...
//# sourceMappingURL=chromecast.map
